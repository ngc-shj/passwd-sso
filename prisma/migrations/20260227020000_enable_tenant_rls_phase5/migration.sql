-- Phase 5: PostgreSQL RLS for tenant isolation (non-FORCE rollout)
--
-- Precondition:
--   app layer sets `SET LOCAL app.tenant_id = '<tenant-id>'` for normal requests
--   or `SET LOCAL app.bypass_rls = 'on'` for trusted internal jobs.
...
-- Optional after production verification:
