...
export default function TeamDashboardPage({
  ...
  return (
    ...
    >
      <div className={isMasterDetail ? "mx-auto w-full max-w-[1280px]" : "mx-auto max-w-4xl w-full"}>
        <EntryListHeader
          icon={headerIcon}
      ...
      <div className={[
        "flex-1 min-h-0",
        isMasterDetail ? "overflow-hidden mx-auto w-full max-w-[1280px]" : "mx-auto max-w-4xl w-full",
      ].join(" ")}>
        {keyPending ? (
