...
describe("getTeamEntryKindState", () => {
  it("maps LOGIN to password kind", () => {
    const result = getTeamEntryKindState(ENTRY_TYPE.LOGIN);
  ...
  it("maps PASSKEY to passkey kind", () => {
    const result = getTeamEntryKindState(ENTRY_TYPE.PASSKEY);
  ...
  it("maps CREDIT_CARD to credit card kind", () => {
    const result = getTeamEntryKindState(ENTRY_TYPE.CREDIT_CARD);
