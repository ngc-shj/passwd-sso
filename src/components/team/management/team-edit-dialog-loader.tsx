    ...
    async function load() {
      try {
        ...
        setData({
          ...
          givenName: blob.givenName as string | null | undefined,
          familyName: blob.familyName as string | null | undefined,
          middleName: blob.middleName as string | null | undefined,
          familyNameKana: blob.familyNameKana as string | null | undefined,
          givenNameKana: blob.givenNameKana as string | null | undefined,
          addressLine1: blob.addressLine1 as string | null | undefined,
          addressLine2: blob.addressLine2 as string | null | undefined,
          city: blob.city as string | null | undefined,
          state: blob.state as string | null | undefined,
          postalCode: blob.postalCode as string | null | undefined,
          country: blob.country as string | null | undefined,
