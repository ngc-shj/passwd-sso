...
//
// extractable: true — the production extension generates keys with extractable:false,
// but tests must export the JWK to compute the thumbprint. This is a documented
// exception: in production the SW generates the key then extracts the public JWK
// for thumbprint computation without needing pkcs8 export.
