...
export const API_ERROR = {
  ...
  MIGRATION_NOT_IN_PROGRESS: "MIGRATION_NOT_IN_PROGRESS",
  ALREADY_E2E_ENABLED: "ALREADY_E2E_ENABLED",
...
const API_ERROR_I18N: Record<ApiErrorCode, string> = {
  ...
  MIGRATION_NOT_IN_PROGRESS: "migrationNotInProgress",
  ALREADY_E2E_ENABLED: "alreadyE2eEnabled",
  MEMBERS_NOT_READY: "membersNotReady",
