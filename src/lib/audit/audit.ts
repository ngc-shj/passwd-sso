...
import { auditLogger, deadLetterLogger, refusedEmitLogger } from "@/lib/audit/audit-logger";
...
import { buildOutboxPayload, type AuditLogParams } from "@/lib/audit/audit-payload";

// The payload builder lives in a module the offline operator CLI can import
// without the application's Prisma singleton (round-7 F-R7-2).
export { buildOutboxPayload, sanitizeMetadata, type AuditLogParams } from "@/lib/audit/audit-payload";
