...
const shareDataSchema = z.object({
  ...
  givenName: z.string().max(ENTRY_NAME_MAX).nullish(),
  familyName: z.string().max(ENTRY_NAME_MAX).nullish(),
  middleName: z.string().max(ENTRY_NAME_MAX).nullish(),
  familyNameKana: z.string().max(ENTRY_NAME_MAX).nullish(),
  givenNameKana: z.string().max(ENTRY_NAME_MAX).nullish(),
  address: z.string().max(ENTRY_SECRET_MAX).nullish(),
  addressLine1: z.string().max(ENTRY_NAME_MAX).nullish(),
  addressLine2: z.string().max(ENTRY_NAME_MAX).nullish(),
  city: z.string().max(ENTRY_NAME_MAX).nullish(),
  state: z.string().max(ENTRY_NAME_MAX).nullish(),
  postalCode: z.string().max(ENTRY_SHORT_MAX).nullish(),
  country: z.string().max(ENTRY_NAME_MAX).nullish(),
