...
export const API_ERROR = {
  ...
  VAULT_RESET_DATA_OUTSIDE_TENANT: "VAULT_RESET_DATA_OUTSIDE_TENANT",
  ...
  HISTORY_RETENTION_INDEFINITE: "HISTORY_RETENTION_INDEFINITE",
  ...
  EXTENSION_TOKEN_DPOP_INVALID: "EXTENSION_TOKEN_DPOP_INVALID",
  ...
  PASSKEY_REAUTH_UNAVAILABLE: "PASSKEY_REAUTH_UNAVAILABLE",
  PASSKEY_REAUTH_CREDENTIAL_MISMATCH: "PASSKEY_REAUTH_CREDENTIAL_MISMATCH",
...
export const API_ERROR_STATUS = {
  ...
  VAULT_RESET_DATA_OUTSIDE_TENANT: 409,
  ...
  HISTORY_RETENTION_INDEFINITE: 409,
  ...
  EXTENSION_TOKEN_DPOP_INVALID: 401,
  ...
  PASSKEY_REAUTH_UNAVAILABLE: 403,
  PASSKEY_REAUTH_CREDENTIAL_MISMATCH: 403,
...
const API_ERROR_I18N: Record<ApiErrorCode, string> = {
  ...
  EXTENSION_TOKEN_DPOP_INVALID: "extensionTokenDpopInvalid",
  ...
  HISTORY_RETENTION_INDEFINITE: "historyRetentionIndefinite",
  ...
  VAULT_RESET_DATA_OUTSIDE_TENANT: "vaultResetDataOutsideTenant",
  ...
  PASSKEY_REAUTH_UNAVAILABLE: "passkeyReauthUnavailable",
  PASSKEY_REAUTH_CREDENTIAL_MISMATCH: "passkeyReauthCredentialMismatch",
